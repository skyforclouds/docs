...
SoraNova supports deploying any Huggingface-hosted LLM via a generic Docker image. Below is a sample configuration for deploying Meta’s Llama 3.1 8B Instruct model. You can customize the hardware allocation, GPU memory, and sharing strategy via Terraform variables:
